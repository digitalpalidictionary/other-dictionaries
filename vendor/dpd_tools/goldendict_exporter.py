...
from vendor.dpd_tools.date_and_time import make_timestamp
    ...
    if dict_var.font_source_path:
        for font_path in dict_var.font_source_path.iterdir():
            if (
                ...
                and font_path.suffix.lower() in [".ttf", ".otf"]
            ):
...
def export_to_goldendict_with_pyglossary(
    ...
    """Export dictionary data to GoldenDict format using pyglossary."""
